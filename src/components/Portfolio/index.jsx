...
import SVD from '../../indiv/svd.json';
import EDGI from '../../indiv/edgi.json';
import styles from './index.module.css';

const portfolio = () => {
	const JSONINFO = [SVD, EDGI, PCA, Reservation, Personal3, FJ, Games, Alien, UsedCar, Personal1, LOF, Hearthstone]
